...
class SchoolCenterCollection extends ResourceCollection
{
    public $collects = SchoolCenterResource::class;
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'type' => 'Centros Escolares (Instituto Nacional De Sonzacate)'
        ];
    }
}
